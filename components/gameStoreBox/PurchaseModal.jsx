...
export function PurchaseModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 rounded-[10px] bg-background/80 backdrop-blur-sm data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0"
      open={isOpen}
    >
      {error2 && (
