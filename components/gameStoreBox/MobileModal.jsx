...
export function MobileModal({
  ...
  return (
    ...
    >
      <div
        className={`sticky top-[25%] col-span-2 bg-[#F9F9F9] rounded-lg shadow-lg p-6 h-max max-sm:fixed max-sm:top-auto max-sm:bottom-[110px] left-0 right-0 w-[30%] mx-auto max-sm:col-span-5 max-sm:${
